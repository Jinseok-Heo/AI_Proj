...
class Model(object):
    def __init__(self, config,
        ...
        self.input_keep_prob_placeholder = tf.compat.v1.placeholder(tf.float32, shape=())
        self.output_keep_prob_placeholder = tf.compat.v1.placeholder(tf.float32, shape=())
        self.orders_placeholder = tf.compat.v1.placeholder(tf.int32, shape=(self.batch_size, ))
        self.enc_inputs_placeholder = tf.compat.v1.placeholder(tf.float32, shape=(self.batch_size, 10, 3))
        self.baselines_placeholder = tf.compat.v1.placeholder(tf.float32, shape=(self.batch_size,))
        self.enc_seq_length_placeholder = tf.compat.v1.placeholder(tf.float32, shape=(self.batch_size, ))
        self.dec_seq_length_placeholder = tf.compat.v1.placeholder(tf.float32, shape=(self.batch_size, ))
        self.adjusted_obj_value = tf.compat.v1.placeholder(tf.float32, shape=(self.batch_size, ))

        ##############
        # inputs
        ##############

        self.is_training = tf.compat.v1.placeholder_with_default(tf.constant(False, dtype=tf.bool),
